<template>
  <section class="py-[50px] flex flex-col items-center justify-center px-4">
    ...
    <!-- Flash Message dengan z-index lebih tinggi -->
    <FlashMessage
      :type="flashType"
  ...
  methods: {
    ...
    async submitLogin() {
      ...
      try {
        ...
        this.flashMessage = 'Login berhasil!'
        this.flashType = 'success'

        // Set delay 1 detik sebelum redirect untuk menampilkan loading
        setTimeout(() => {
          this.isLoading = false
          this.$router.push('/')
        }, 1000)
      } catch (error) {
        this.flashMessage = 'Login gagal. Periksa email dan kata sandi Anda.'
        this.flashType = 'error'
        this.isLoading = false // Jangan lupa set isLoading kembali ke false
      }
    },
  },
}
