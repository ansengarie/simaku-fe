<template>
  <section class="py-[50px] flex flex-col px-4">
    ...
    <div class="flex justify-center justify-self-center mt-[5px]">
      <form class="w-full card" @submit.prevent="tambahKaryawan">
  ...
  methods: {
    async tambahKaryawan() {
      try {
        ...
        this.flashMsg = 'Data karyawan berhasil ditambahkan!'
        ...
        this.flashMsg = 'Terjadi kesalahan saat menambahkan data karyawan.'
      }
    },
    clearFlashMessage() {
      this.flashType = ''
