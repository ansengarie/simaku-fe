...
export default {
  ...
  methods: {
    ...
    calculateTotalGaji() {
      this.totalGaji = 0 // Reset total
      for (const key in this.transaksiData.gaji_universitas) {
        this.totalGaji += Number(this.transaksiData.gaji_universitas[key]) || 0
      }
    },
  },
  computed: {
