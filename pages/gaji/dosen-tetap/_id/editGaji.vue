...
export default {
  ...
  async asyncData({ params, $axios }) {
    try {
      ...
      const response = await $axios.get(
        `/dosentetap/gaji/transaksi/${params.id}`,
        { headers }
      )
  ...
  mounted() {
    ...
    if (this.transaksiData) {
      ...
      this.gaji_fakultas.honor_mengajar_dpk = gajiFakultas.honor_mengajar_dpk
      this.gaji_fakultas.peny_honor_mengajar = gajiFakultas.peny_honor_mengajar
    ...
    async tambahTransaksiGaji() {
      try {
        ...
        const response = await this.$axios.put(
          `/dosentetap/gaji/transaksi/update/${this.transaksiData.id}`,
          dataToPost,
          {
            headers: {
